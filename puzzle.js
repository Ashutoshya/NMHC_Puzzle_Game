document.addEventListener('DOMContentLoaded',function(){
    ...
    this.Puzzle = function(opts) {
        ...
        this.settings = {
            el             : null,
            image          : 'https://raw.githubusercontent.com/Ashutoshya/NMHC_Puzzle_Game/main/2NMHC_MasterPlan.jpg',
            fullImg        : null,
            numcolumns     : 5,
            numrows        : 5,
            difficulty     : "normal",
        ...
        this.startTimerButton = document.getElementById('start-timer');
        this.stopTimerButton = document.getElementById('stop-timer');
        ...
        this.startTimer = function() {
            ...
            this.stopTimerButton.disabled = false;
            this.resetTimerButton.disabled = true; // Disable reset while running
    };
        ...
        this.stopTimer = function() {
            ...
            this.stopTimerButton.disabled = true;
            this.resetTimerButton.disabled = false; // Enable reset after stopping
    };
        ...
        this.resetTimer = function() {
            ...
            this.startTimerButton.disabled = false;
            this.stopTimerButton.disabled = true;
            this.resetTimerButton.disabled = true; // Disable reset after resetting
    };
